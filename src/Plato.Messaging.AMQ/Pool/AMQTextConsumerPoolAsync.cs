...
namespace Plato.Messaging.AMQ.Pool
{
    ...
    internal class AMQTextConsumerPoolAsync : GenericObjectPoolAsync<IAMQReceiverText, AMQPoolStates>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AMQTextConsumerPoolAsync"/> class.
        /// </summary>
        /// <param name="states">The states.</param>
        /// <param name="initialPoolSize">Initial size of the pool.</param>
        /// <param name="maxGrowSize">Maximum size of the grow.</param>
        public AMQTextConsumerPoolAsync(
