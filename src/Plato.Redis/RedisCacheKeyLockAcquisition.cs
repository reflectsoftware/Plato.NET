...
namespace Plato.Redis
{
    ...
    public class RedisCacheKeyLockAcquisition : IRedisCacheKeyLockAcquisition
    {
        ...
        /// <returns></returns>
        public RedisCacheKeyLock AcquireLock(IDatabase db, RedisKey key, TimeSpan? retryTimeout = null, TimeSpan? expiry = null)
        {
        ...
        /// <param name="expiry">The expiry.</param>
        /// <returns></returns>
        public Task<RedisCacheKeyLock> AcquireLockAsync(IDatabase db, RedisKey key, TimeSpan? retryTimeout = null, TimeSpan? expiry = null)
        {
