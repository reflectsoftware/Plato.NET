...
namespace Plato.Messaging.Implementations.AMQ
{
    ...
    public class AMQSenderText: AMQSender, IAMQSenderText
    {
        ...
        public AMQSenderText(IAMQConnectionFactory connectionFactory, string connectionName, AMQDestinationSettings destination) : base(connectionFactory, connectionName, destination)
        {
        }
